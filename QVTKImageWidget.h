...
typedef itk::VTKImageExport<ImageType>	itkVTKImageExportType;
...
public:
     ...
     * \param[in] a vtkImageData to set and display
     */
	void setAndDisplayImage(ImageType::Pointer image);
...
private:    
    ...
    itkVTKImageExportType::Pointer			itkVTKExporter; 
	vtkConnectorType::Pointer				connector;
